...
#         self.add_all_items()
#
#         items_to_buy = self.sauce_demo.inventory_page.get_items()
#
#         self.click_cart()
#         self.click_checkout()
#         self.fill_billing_info()
...
#             expected += item.price
#
#         actual = self.sauce_demo.checkout_two_page.subtotal
#         actual = OverViewTestCase.convert_to_float(actual)
#
#         self.assertEqual(expected, actual)
#
#         expected = expected * TAX
#         actual = self.sauce_demo.checkout_two_page.total
#         actual = OverViewTestCase.convert_to_float(actual)
#
...
#         self.fill_billing_info()
#
#         overview_items = self.sauce_demo.checkout_two_page.get_items()
#
