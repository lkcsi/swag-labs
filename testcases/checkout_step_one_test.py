...
#         self.assertTrue(
#             f"{input_field} is required"
#             in self.sauce_demo.checkout_one_page.error_text,
#             f"Error message should be: {input_field} is required",
#         )
#
#     def check_wrong(self):
#         self.assertTrue(
#             self.sauce_demo.checkout_one_page.error_text != "",
...
#         self.click_checkout()
#
#         checkout_one_page.first_name = first_name
#         checkout_one_page.last_name = last_name
#         checkout_one_page.postal_code = postal_code
#
...
#             f"Should proceed with valid input, error: {self.sauce_demo.checkout_one_page.error_text}",
#         )
#
#
